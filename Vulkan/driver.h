...
public:
    ...
    TrianglesDrawer (std::vector<Vertex>  vertex_, std::vector<uint16_t>  indices_, cam::Camera camera_):
...
private:
    ...
    static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
        auto app = reinterpret_cast<TrianglesDrawer*>(glfwGetWindowUserPointer(window));
