...
public:
    ...
    std::pair<geo::Vector, Intersec> IntersecLineLine( const geo::Line& l, const geo::Line& r) const;
    std::pair<geo::Vector, Intersec> IntersecCutLine(const geo::Cut& c, const geo::Line& l) const;
    std::pair<geo::Cut, Intersec> IntersecLineAndTr(const geo::Line& l, const geo::Triangle& t, const geo::Triangle &t1) const;
    std::pair<geo::Line, Intersec> IntersecPlanePlane(const geo::Plane& p1, const geo::Plane& p2) const;

    bool IsInclude(const geo::Triangle& t,const geo::Vector& p) const;
    bool IsInclude(const geo::Plane& t,const geo::Vector& p) const noexcept;
    bool IsInclude(const geo::Cut& c, const geo::Vector& p) const noexcept;
    bool IsInclude(const geo::Line& l, const geo::Vector& p) const noexcept;
    bool IsInclude(const geo::Rectangle& l, const geo::Rectangle& r) const noexcept ;
    bool IsInclude(const geo::Rectangle& r, const geo::Vector& p) const noexcept ;

    geo::Plane GetPlaneFromTr(const geo::Triangle& t) const noexcept ;

    bool CheckCollision (const geo::Triangle& t1, const geo::Triangle& t2) const;
    bool CheckCollision(const geo::Rectangle& l, const geo::Rectangle& r) const noexcept;
    bool CheckCollision(const geo::Rectangle& r, const geo::Triangle& t) const noexcept;
...
bool Space::IsInclude(const geo::Line& l, const geo::Vector& p) const noexcept {

    return geo::AreParallel(l.A_, l.D_ - p);
}

bool Space::IsInclude(const geo::Cut& c, const geo::Vector& p) const noexcept {

    return geo::AreCoDirected(p - c.A_, c.B_ - p);
}

bool Space::IsInclude(const geo::Plane& t,const geo::Vector& p) const noexcept {

    return (t.D0_ * t.N_ - p * t.N_) < geo::eps;
}


bool Space::IsInclude(const geo::Triangle& t,const geo::Vector& p) const {
...
bool Space::IsInclude(const geo::Rectangle& l, const geo::Rectangle& r) const noexcept {

    return IsInclude(l, r.v_min_) && IsInclude(l, r.v_max_);
}

bool Space::IsInclude(const geo::Rectangle& r, const geo::Vector& p) const noexcept {
...
geo::Plane Space::GetPlaneFromTr(const geo::Triangle &t) const noexcept {
...
std::pair<geo::Vector, Intersec> Space::IntersecLineLine(const geo::Line& l, const geo::Line& r) const {
...
std::pair<geo::Vector, Intersec> Space::IntersecCutLine(const geo::Cut& c, const geo::Line& l) const {
...
std::pair<geo::Line, Intersec> Space::IntersecPlanePlane(const geo::Plane& p1, const geo::Plane& p2) const {
    ...
    {
        throw std::invalid_argument("Something error");
    }
    else
    {
...
std::pair<geo::Cut, Intersec> Space::IntersecLineAndTr(const geo::Line& l, const geo::Triangle& t, const geo::Triangle &t1) const{
    ...
    else
    {
        ...
        else {  throw std::invalid_argument("Something error"); }
    }
...
bool Space::CheckCollision(const geo::Triangle &t1, const geo::Triangle &t2) const{
...
bool Space::CheckCollision(const geo::Rectangle& l, const geo::Rectangle& r) const noexcept {
...
bool Space::CheckCollision(const geo::Rectangle& r, const geo::Triangle& t) const noexcept {
